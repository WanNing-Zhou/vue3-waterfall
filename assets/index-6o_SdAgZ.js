...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const num = useModel(__props, "num");
    const inputRef = ref();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createBaseVNode("span", null, toDisplayString(_ctx.alias), 1),
        createBaseVNode("button", { onMousedown: addHandle }, "+", 32),
        createBaseVNode("input", {
          ref_key: "inputRef",
          ref: inputRef,
          value: num.value,
          onChange: _cache[0] || (_cache[0] = //@ts-ignore
          (...args) => unref(changeHandle) && unref(changeHandle)(...args))
        }, null, 40, _hoisted_2$1),
        createBaseVNode("button", { onMousedown: subHandle }, "-", 32)
      ]);
    };
  }
});
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2, [
          ...
          createVNode(WqInput, {
            alias: "列间距：",
            num: columnGap.value,
            "onUpdate:num": _cache[1] || (_cache[1] = ($event) => columnGap.value = $event)
          }, null, 8, ["num"]),
          createVNode(WqInput, {
            alias: "行间距：",
            num: rowGap.value,
            "onUpdate:num": _cache[2] || (_cache[2] = ($event) => rowGap.value = $event)
          }, null, 8, ["num"]),
          createVNode(WqInput, {
            span: 100,
            alias: "宽度：",
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(DefaultLayout)
      ]);
    };
  }
});
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-32e414a8"]]);
